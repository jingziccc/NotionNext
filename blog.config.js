...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || 'Hi，猪婆, Hi，花瓶,Hi，我是Jingziccc,欢迎来到我们的博客🎉',
  ...
  WIDGET_PET_LINK:
        ...
        'https://cdn.jsdelivr.net/npm/live2d-widget-model-wanko@1.0.5/assets/Pio.model.json', // 挂件模型地址 @see https://github.com/xiazeyu/live2d-widget-models
  ...
  DESCRIPTION:
        process.env.NEXT_PUBLIC_DESCRIPTION || '镜与墙', // 站点描述，被notion中的页面描述覆盖
